...
<div class="row no-gutters mt-5">
  ...
  <li class="nav-item">
    ...
    <div class="col-md-10 p-5 pt-2">
      <h3><i class="fas fa-calendar-alt mr-2"></i> Jadwal Kerja</h3><hr>

      <a href="" class="btn btn-primary mb-3"><i class="fas fa-plus-square mr-2"></i>Tambahkan Data Jadwal kerja</a>
